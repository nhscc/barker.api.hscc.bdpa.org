[barker.api.hscc.bdpa.org][1] / src/pages/api/v1/users
...
Defined in: [src/pages/api/v1/users/index.ts:8][5]
...
[5]:
  https://github.com/nhscc/barker.api.hscc.bdpa.org/blob/08a500c/src/pages/api/v1/users/index.ts#L8
