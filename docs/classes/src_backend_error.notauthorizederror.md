[barker.api.hscc.bdpa.org][1] / [src/backend/error][2] / NotAuthorizedError
...
\+ **new NotAuthorizedError**(`message?`: _string_): [_NotAuthorizedError_][11]
...
**Returns:** [_NotAuthorizedError_][11]

Overrides: [AppError][3]

Defined in: node_modules/named-app-errors/dist/modules/index.d.ts:17
...
[11]: src_backend_error.notauthorizederror.md
